            ...
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div class="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                    <ul class="list-disc list-inside space-y-8">
                        ...
                        <li><a href="https://wa.me/085234983438" target="_blank" class="hover:text-sky-400 transition">Contact</a></li>
...
<path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                        ...
                        <li> --}}
                            <a href="https://wa.me/085234983438" target="_blank" class="flex items-center space-x-3 hover:text-sky-400 transition">
                                <img class="w-5 h-5" src="https://seeklogo.com/images/W/whatsapp-logo-8AE44BBBB0-seeklogo.com.png" alt="wa icon">
                                <span>WhatsUp</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/intric.id/"  target="_blank" class="flex items-center space-x-3 hover:text-sky-400 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-5" viewBox="0 0 16 16">
                ...
                <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                    ...
                    <span class="block text-gray-300">Need help? <a href="https://wa.me/085234983438" target="_blank" class="font-semibold text-white"> Contact Us</a></span>
                </div>
            </div>
        </div>
    </div>
