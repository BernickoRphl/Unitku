...
@section('content')
    ...
    <div class="box-container">
        @foreach ($teams as $teamMember)
            <section class="team" id="team{{ $teamMember->id }}">
                <div class="box">
                    <span class="classification">{{ $teamMember->position }}</span>
                    <div class="image">
                        <img src="/resources/images/{{ $teamMember->team_image }}" alt="" />
                    </div>
                    <div class="content">
                        <h3>{{ $teamMember->name }}</h3>
                        <div class="price">{{ $teamMember->desc }}</div>
                    </div>
                </div>
            </section>
        @endforeach
