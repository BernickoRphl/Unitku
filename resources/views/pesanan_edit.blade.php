    ...
    <form method="POST" action="{{ route('pesanan.update', $pesananEdit) }}" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input id="address" type="text" class="form-control @error('name') is-invalid @enderror" name="address"
                    value="{{ $pesananEdit->address }}" readonly autocomplete="address" autofocus>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input id="jumlah" type="text" class="form-control" name="jumlah" value="{{ $pesananEdit->jumlah }}"
                    readonly autocomplete="jumlah">
