  ...
  <body class="bg-gray-100">
      ...
      <div class="flex shadow-md my-10">
        <div class="w-3/4 bg-white px-10 py-10">
          ...
          <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
            ...
            <div class="flex justify-center w-1/5">
                <svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512" onclick="incrementValue(this)">
                    <path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                </svg>

                <input id="quantityInput" class="mx-2 border text-center w-8" type="text" value="1">

                <svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512" onclick="decrementValue(this)">
                    <path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                </svg>
            </div>
    ...
    <script>
        ...
        function updateTotal(productIndex) {
            var quantityInput = document.getElementById('quantityInput' + productIndex);
            var totalElement = document.getElementById('total' + productIndex);
            var priceElement = document.getElementById('price' + productIndex);
        ...
        document.getElementById('quantityInput1').addEventListener('input', function () {
            updateTotal(1);
        });

        document.getElementById('quantityInput2').addEventListener('input', function () {
            updateTotal(2);
        });

        document.getElementById('quantityInput3').addEventListener('input', function () {
            updateTotal(3);
        });
    </script>
